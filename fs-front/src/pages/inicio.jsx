              ...
              <Col span={12}>
                <Card title="Top Productos Vendidos" style={cardStyle}>
                  {renderChart(
                    "bar",
                    topProducts,
                    barData(topProducts, "producto__nombre", "total_vendido")
                  )}
                </Card>
              </Col>
              <Col span={12}>
                <Card title="Top Productos Comprados" style={cardStyle}>
                  {renderChart(
                    "bar",
                    topPurchased,
                    barData(topPurchased, "producto__nombre", "total_comprado")
                  )}
                </Card>
              </Col>
            </Row>
              ...
              <Col span={12}>
                <Card title="Top Clientes que más gastan" style={cardStyle}>
                  {renderChart(
                    "bar",
                    topClients,
                    barData(topClients, "cliente_nombre", "total_gastado")
                  )}
                </Card>
              </Col>
              <Col span={12}>
                <Card title="Productos con Mayor Stock" style={cardStyle}>
                  {renderChart(
                    "bar",
                    topStock,
                    barData(topStock, "nombre", "cantidad")
                  )}
                </Card>
              </Col>
            </Row>
