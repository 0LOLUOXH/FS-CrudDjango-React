            ...
            <table className="w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">ESTADOS</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {proveedores.map(p => (
                  <tr key={p.id} className="hover:bg-gray-50">
                    ...
                    <td><p className={`px-2 inline-flex text-sm font-semibold rounded-full rounded-full ${p.estado?
